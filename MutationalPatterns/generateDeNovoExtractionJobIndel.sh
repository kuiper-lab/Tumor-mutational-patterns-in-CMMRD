...
###PARAMETERS
SAMPLE="CMMRD_ControlCohort1_6sigs"
...
JOBNAME="$SAMPLE-denovoextractionIndel"
OUTPUTLOG="$JOB_DIR/$SAMPLE-denovoextractionIndel.sh.out"
ERRORLOG="$JOB_DIR/$SAMPLE-denovoextractionIndel.sh.err"
WALLTIME="01:59:00"
NUMTASKS="1"
NUMCPUS=1
MEM="20G"
TMPSPACE="10G"
JOBFILE="$JOB_DIR/$SAMPLE-denovoextractionIndel.sh"
